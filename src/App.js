...
class App extends Component {
  ...
  render() {
    ...
    const { city, country, temperatureC, temperatureF, humidity, description, icon, sunrise, sunset} = this.state;
      ...
      return (
        <div className="App">
          ...
          <div className="weather">
            <div className="weather-item">{city}, {country}</div>  
            ...
            <div className="weather-item">{description}</div>
            <div>
